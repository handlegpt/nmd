-- Minimal Seed Places Data for Popular Nomad Cities
-- This script only uses the most basic columns that definitely exist
...
-- Insert places data using only the most basic columns
-- Bangkok Places
...
-- Note: This script uses only the most basic columns that definitely exist
-- It includes 22 places across major nomad cities with essential information
