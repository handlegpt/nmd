-- Safe Place Features Database Tables
-- This version creates tables step by step to avoid dependency issues

-- Step 1: Create Place Reviews Table
...
-- Step 2: Create Place Photos Table
...
-- Step 3: Create Place Check-ins Table
...
-- Step 5: Create indexes for place_reviews
...
-- Step 6: Create indexes for place_photos
...
-- Step 7: Create indexes for place_checkins
...
-- Step 8: Create indexes for user_activity
...
-- Step 9: Create updated_at function
...
-- Step 11: Create Supabase Storage bucket for place photos
INSERT INTO storage.buckets (id, name, public) 
VALUES ('place-photos', 'place-photos', true)
ON CONFLICT (id) DO NOTHING;

-- Step 12: Set up RLS policies for place photos bucket
