-- Place Features Database Tables
-- Supporting reviews, photos, check-ins, and real-time features
...
-- User Activity Table (for real-time online status)
