-- User preferences and favorites data tables (Clean Version)
-- This version handles existing triggers and tables properly
...
-- 2. Drop existing tables if they exist (in reverse order due to foreign key constraints)
