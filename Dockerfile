...
ARG EXPO_PUBLIC_SMTP_HOST
ARG EXPO_PUBLIC_SMTP_PORT
ARG EXPO_PUBLIC_SMTP_USER
ARG EXPO_PUBLIC_SMTP_PASS
ARG EXPO_PUBLIC_FROM_EMAIL
ARG EXPO_PUBLIC_FROM_NAME
...
ENV EXPO_PUBLIC_SMTP_HOST=$EXPO_PUBLIC_SMTP_HOST
ENV EXPO_PUBLIC_SMTP_PORT=$EXPO_PUBLIC_SMTP_PORT
ENV EXPO_PUBLIC_SMTP_USER=$EXPO_PUBLIC_SMTP_USER
ENV EXPO_PUBLIC_SMTP_PASS=$EXPO_PUBLIC_SMTP_PASS
ENV EXPO_PUBLIC_FROM_EMAIL=$EXPO_PUBLIC_FROM_EMAIL
ENV EXPO_PUBLIC_FROM_NAME=$EXPO_PUBLIC_FROM_NAME
